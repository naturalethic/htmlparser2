...
function Parser(cbs, options){
	...
	this.openImpliesClose = this._options.openImpliesClose || openImpliesClose;
	this.voidElements = this._options.voidElements || voidElements;
...
Parser.prototype.onopentagname = function(name){
	...
	if (!this._options.xmlMode && name in this.openImpliesClose) {
		for(
			var el;
			(el = this._stack[this._stack.length-1]) in this.openImpliesClose[name];
			this.onclosetag(el)
		);
	}

	if(this._options.xmlMode || !(name in this.voidElements)){
...
Parser.prototype.onopentagend = function(){
	...
	if(!this._options.xmlMode && this._cbs.onclosetag && this._tagname in this.voidElements){
...
Parser.prototype.onclosetag = function(name){
	...
	if(this._stack.length && (!(name in this.voidElements) || this._options.xmlMode)){
